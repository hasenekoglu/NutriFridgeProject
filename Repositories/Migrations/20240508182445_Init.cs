        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FoodValue = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodsMaterials", x => new { x.FoodId, x.MaterialId });
                    table.ForeignKey(
                        name: "FK_FoodsMaterials_Foods_FoodId",
                        column: x => x.FoodId,
                        principalTable: "Foods",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FoodsMaterials_Materials_MaterialId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FoodsMaterials_MaterialId",
                table: "FoodsMaterials",
                column: "MaterialId");
